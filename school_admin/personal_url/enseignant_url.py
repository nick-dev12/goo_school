...
from ..personal_views.enseignant_view import (
    ...
    modifier_evaluation_enseignant,
    supprimer_evaluation_enseignant,
    ...
    historique_annees_enseignant,
    detail_historique_annee_enseignant,
...
urlpatterns = [
    ...
    path('enseignant/modifier-evaluation/<int:evaluation_id>/', modifier_evaluation_enseignant, name='modifier_evaluation'),
    path('enseignant/supprimer-evaluation/<int:evaluation_id>/', supprimer_evaluation_enseignant, name='supprimer_evaluation'),
    ...
    path('enseignant/historique-annees/', historique_annees_enseignant, name='historique_annees'),
    path('enseignant/historique-annees/<int:annee_id>/', detail_historique_annee_enseignant, name='historique_annee_detail'),
