...
(function () {
  ...
  function clearSearchAttestation(classeId) {
    var searchInput = document.getElementById('search-input-' + classeId);
    if (searchInput) {
      searchInput.value = '';
  ...
  function resetFiltersAttestation(classeId) {
    var searchInput = document.getElementById('search-input-' + classeId);
    var filterSexe = document.getElementById('filter-sexe-' + classeId);
  ...
  document.addEventListener('click', function (event) {
    ...
    if (clearBtn) {
      clearSearchAttestation(clearBtn.getAttribute('data-clear-search'));
      return;
    }
    var resetBtn = event.target.closest('[data-reset-filters]');
    if (resetBtn) {
      resetFiltersAttestation(resetBtn.getAttribute('data-reset-filters'));
    }
  });
