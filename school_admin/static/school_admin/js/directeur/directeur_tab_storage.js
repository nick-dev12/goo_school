/**
 * Persistance onglets directeur — query string + localStorage (Vague 2+).
 */
(function (global) {
  'use strict';
  ...
  /**
   * Complète l’URL depuis le localStorage si des paramètres manquent.
   * @returns {Object} valeurs courantes des champs demandés
   */
